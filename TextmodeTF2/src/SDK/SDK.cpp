...
namespace SDK
{
	bool g_bMapLoading = true; //dont disable it
	bool g_bAggressiveOptimization = true;  //dont disable it
	double g_flMapLoadStartTime = 0.0; //dont change idk what the fuck did i did but just dont touch this ok?
}
